    ...
    <section className=' h-full common-padding relative overflow-hidden bg-zinc'>
      <div className=" screen-max-width">
        ...
        <div className=" flex flex-col justify-center items-center overflow-hidden">
          ...
          <div className=" fkex-center flex-col sm:px-10">
            ...
            <div className=" flex flex-col w-full relative">
              ...
              <div className="feature-text-container">
                <div className=" flex-1 flex-center">
                  <p className="feature-text g_text">
                    ...
                    <span className="text-white">
                      the frist iPhone to feature an aerospace-grade titanium design
                    </span>,
                ...
                <div className=" flex-1 flex-center">
                  <p className="feature-text g_text">
                    Titanium has one of the best strength-to-weight ratios of any metal, makking these  uor {' '}
                    <span className="text-white">
